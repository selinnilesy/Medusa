...
from SnapKV.snapkv.monkeypatch.snapkv_utils import init_snapkv
    ...
    def forward(
        ...
        if past_key_value is not None:
            ...
            if key_states.shape[-2] == kv_seq_len:
                past_key_value[0].data = repeat_kv(past_key_value[0].data, self.num_key_value_groups)
                past_key_value[1].data = repeat_kv(past_key_value[1].data, self.num_key_value_groups)
